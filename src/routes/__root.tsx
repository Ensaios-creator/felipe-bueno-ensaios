...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Configurador de Ensaios" },
      {
        name: "description",
        content: "Monte seu ensaio fotográfico escolhendo look, cenário, luz e poses.",
      },
      { property: "og:title", content: "Configurador de Ensaios" },
      {
